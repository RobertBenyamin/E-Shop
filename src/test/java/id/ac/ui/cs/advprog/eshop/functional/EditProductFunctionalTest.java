...
public class EditProductFunctionalTest {
    ...
    void editProduct_isCorrect (ChromeDriver driver) throws Exception {
        ...
        driver.findElement(By.id("nameInput")).clear();
        driver.findElement(By.id("nameInput")).sendKeys("Sampo Cap Bango");
        driver.findElement(By.id("quantityInput")).clear();
        ...
        // Verify
        WebElement product = driver.findElement(By.id("name_1"));
        assertEquals(product.getText(), "Sampo Cap Bango");
        
        product = driver.findElement(By.id("quantity_1"));
        assertEquals(product.getText(), "50");
    }
}
